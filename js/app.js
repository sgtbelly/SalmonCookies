...
function headerRow () {
  ...
  var trEl = document.getElementById('trEl');
  var thEl = document.getElementById('thEL');
  trEl.appendChild(thEl);

  for(var i = 0; i < hours.length; i++){
    thEl = document.createElement('th');var totalCookiesPerHour = 0;
    var netTotal = 0;
  ...
  trEl.appenedChild(thEl);
  cookieShops.appenedChild(trEl);
}
headerRow();
